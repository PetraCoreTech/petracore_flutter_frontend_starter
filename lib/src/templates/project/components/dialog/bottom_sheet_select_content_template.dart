...
class BottomSheetSelectContent<T> extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final primaryDark = colors.primaryDark.resolve(context);
    final label3 = \$token.textStyle.label3.resolve(context);
          ...
          ...filtered.value.map(
            (e) => SelectItemV2<T>(
              ...
              titleStyle: titleStyle ??
                  label3.copyWith(color: colors.onSurface.resolve(context)),
              subtitle: e.subtitle,
              prefix: itemPrefix,
                  ...
                  if (prefix != null)
                    ...
                    Icon(
                      ...
                      color: prefixIconColor ??
                          colors.onSurfaceDark.resolve(context),
                    ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (subtitle != null) ...[
                          Text(
                            subtitle!,
                            style: \$token.textStyle.paragraph4
                                .resolve(context)
                                .copyWith(
          ...
          child: showHighlighted
              ? DecoratedBox(
                  decoration: BoxDecoration(
                    color: isSelected ? colors.hover.resolve(context) : null,
                  ),
                  child: item,
                )
              : item,
