...
import '../buttons/app_button.dart'; // For IconAlignment enum

part 'app_outline_button_style.dart';
part 'app_outline_button_type.dart';

/// Outline button component with mixtheme integration for ${config.projectName}
class AppOutlineButton extends StatelessWidget {
  ...
  /// Factory constructor for button with icon
