...
abstract class AuthServicesInterface {
  Future<Response<dynamic>> checkUser(String target);

  Future<Response<dynamic>> forgotPassword(ResetPasswordDto data);

  Future<Response<dynamic>> login(LoginDto data);

  Future<Response<dynamic>> requestOtp(String target);

  Future<Response<dynamic>> signup(SignupDto data);

  Future<Response<dynamic>> verifyEmail(VerifyDto data);
...
class AuthService extends AuthServicesInterface{
  ...
  Future<Response> checkUser(CheckUserDto data) async {
    return await apiClient.post(
      endpoint: '/auth/check_user',
      data: data.toJson(),
    );
  }
  
  @override
  Future<Response> forgotPassword(ResetPasswordDto data) async {
    return await apiClient.post(
  ...
  @override
  Future<Response> verifyEmail(VerifyDto data) async {
    return await apiClient.post(
