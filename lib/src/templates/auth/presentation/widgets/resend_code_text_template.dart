...
String resendCodeTextTemplate(ProjectConfig config) => '''
import 'dart:async';
            ...
            children: [
              if (count.value > 0)
                TextSpan(
                  ...
                  style: \$token.textStyle.paragraph3.resolve(context).copyWith(
                ...
                TextSpan(
                  ...
                  style: \$token.textStyle.label3.resolve(context).copyWith(
                        color: colors.primaryPressed.resolve(context),
                        height: 1,
                      ),
