...
void main() async {
  ...
  print(
      '🔧 Next step: Update project_templates.dart to include new imports and getters');
}
...
Future<void> _createComponentTemplate(ComponentInfo component) async {
  final file =
      File('lib/src/templates/project/components/${component.fileName}');
  ...
  return [
    ...
    ComponentInfo(
      ...
      dependencies: [
        ...
        '../../theme/design_tokens/theme_token.dart'
      ],
    ),
    ComponentInfo(
...
String _generateTemplateContent(ComponentInfo component) {
  final imports =
      component.dependencies.map((dep) => "import '$dep';").join('\\n');
...
class ComponentInfo {
  ...
  String get functionName =>
      fileName.replaceAll('_template.dart', 'Template').replaceAll('_', '');
}
